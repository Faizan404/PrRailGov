...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const renderSchedules = async () => {
        ...
        const lhrNwlResult = await getSchedules('lhr_nwl_departure');
        const nwlLhrResult = await getSchedules('nwl_lhr_arrival');
        
        const lhrNwlDepartures = lhrNwlResult.success ? lhrNwlResult.data : [];
        const nwlLhrArrivals = nwlLhrResult.success ? nwlLhrResult.data : [];

        populateTable(departuresTableBody, lhrNwlDepartures, 'lhr_nwl_departure');
        populateTable(arrivalsTableBody, nwlLhrArrivals, 'nwl_lhr_arrival');
    };
