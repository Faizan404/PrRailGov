...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const renderSchedules = async () => {
        ...
        const lhrMianwaliResult = await getSchedules('lhr_mianwali_departure');
        const mianwaliLhrResult = await getSchedules('mianwali_lhr_arrival');
        
        const lhrMianwaliDepartures = lhrMianwaliResult.success ? lhrMianwaliResult.data : [];
        const mianwaliLhrArrivals = mianwaliLhrResult.success ? mianwaliLhrResult.data : [];

        populateTable(departuresTableBody, lhrMianwaliDepartures, 'lhr_mianwali_departure');
        populateTable(arrivalsTableBody, mianwaliLhrArrivals, 'mianwali_lhr_arrival');
    };
