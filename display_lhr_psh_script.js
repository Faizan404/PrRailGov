...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const renderSchedules = async () => {
        ...
        const lhrPshResult = await getSchedules('lhr_psh_departure');
        const pshLhrResult = await getSchedules('psh_lhr_arrival');
        
        const lhrPshDepartures = lhrPshResult.success ? lhrPshResult.data : [];
        const pshLhrArrivals = pshLhrResult.success ? pshLhrResult.data : [];

        populateTable(departuresTableBody, lhrPshDepartures, 'lhr_psh_departure');
        populateTable(arrivalsTableBody, pshLhrArrivals, 'psh_lhr_arrival');
    };
