...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const renderSchedules = async () => {
        ...
        const lhrQtaResult = await getSchedules('lhr_qta_departure');
        const qtaLhrResult = await getSchedules('qta_lhr_arrival');
        
        const lhrQtaDepartures = lhrQtaResult.success ? lhrQtaResult.data : [];
        const qtaLhrArrivals = qtaLhrResult.success ? qtaLhrResult.data : [];

        populateTable(departuresTableBody, lhrQtaDepartures, 'lhr_qta_departure');
        populateTable(arrivalsTableBody, qtaLhrArrivals, 'qta_lhr_arrival');
    };
